            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if not self.config.dry_run and result["files_migrated"] and not result["errors"]:
                    ...
                    frontend_repo.index.commit(
                        "feat: add Node.js dependencies for frontend development\n\n"
                        "Migrated from backend repository:\n"
                        "- package.json: Tailwind CSS dependencies\n"
                        "- node_modules/: Frontend build tools and dependencies\n\n"
                        "This enables proper frontend development environment."
                    )
