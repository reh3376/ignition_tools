    ...
    for endpoint in endpoints:
        ...
        try:
            ...
            if status == 200:
                ...
                print(f"{icon} {endpoint:<30} | HTTP {status} | {content_type} | {content_length} bytes")
...
def test_gateway_with_working_endpoint(gateway_config, working_endpoints):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if any(indicator in content for indicator in ['ignition', 'inductiveautomation', 'gateway']):
