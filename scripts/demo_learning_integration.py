...
def demo_cli_integration():
    ...
    try:
        ...
        demo_commands = [
            ("script", "generate", {"template": "button_click_handler.jinja2", "interactive": True}),
...
def demo_ui_integration():
    ...
    try:
        from src.ui.learning_integration import (
            get_learning_system, track_page_visit, track_script_generation,
        ...
        templates = ["button_click_handler.jinja2", "window_opener.jinja2", "tag_writer.jinja2"]
