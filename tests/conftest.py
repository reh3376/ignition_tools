...
def sample_button_config():
    ...
    return {
        ...
        "window_params": {"test_param": "test_value"},
...
def mock_streamlit():
    ...
    with patch("streamlit.title"), patch("streamlit.header"), patch(
        "streamlit.subheader"
    ), patch("streamlit.text"), patch("streamlit.markdown"), patch(
        "streamlit.button"
    ), patch("streamlit.selectbox"), patch("streamlit.text_input"), patch(
        "streamlit.text_area"
    ), patch("streamlit.checkbox"), patch("streamlit.radio"), patch(
        "streamlit.columns"
    ), patch("streamlit.sidebar"), patch("streamlit.expander"):
        yield
