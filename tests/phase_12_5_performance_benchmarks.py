        ...
        try:
            ...
            report = {
                ...
                "summary": {
                    ...
                    "avg_requests_per_second": statistics.mean([r.requests_per_second for r in benchmark_results]) if benchmark_results else 0,
                    "avg_response_time_ms": statistics.mean([r.avg_response_time_ms for r in benchmark_results]) if benchmark_results else 0,
                    "max_error_rate_percent": max([r.error_rate_percent for r in benchmark_results]) if benchmark_results else 0,
                },
            }
