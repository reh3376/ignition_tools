...
class LearningSystemUI:
    ...
    def track_action(self, action_type: str, details: Dict[str, Any] = None, success: bool = True):
    ...
    def display_learning_dashboard(self):
        ...
        try:
            ...
            with col2:
                ...
                confidence_rate = (high_conf / (high_conf + med_conf + low_conf)) if (high_conf + med_conf + low_conf) > 0 else 0
