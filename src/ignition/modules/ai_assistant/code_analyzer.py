...
class CodeAnalyzer:
    ...
    def _get_context_aware_type(self, var_name: str, line_number: int) -> Optional[str]:
        ...
        for cm_var, (start_line, end_line, cm_type) in self.context_manager_vars.items():
    ...
    def _is_likely_class_instantiation(self, func_name: str, full_name: Optional[str]) -> bool:
        ...
        known_classes = {
            "AsyncWebCrawler", "Client", "CrossEncoder", "KnowledgeGraphValidator",
            "DirectNeo4jExtractor", "HallucinationReporter", "AIScriptAnalyzer"
        }
    ...
    def _handle_async_with(self, node: ast.AsyncWith, result: AnalysisResult):
        ...
        for item in node.items:
            if item.optional_vars and isinstance(item.optional_vars, ast.Name):
                ...
                if cm_type:
                    self.context_manager_vars[var_name] = (start_line, end_line, cm_type)
