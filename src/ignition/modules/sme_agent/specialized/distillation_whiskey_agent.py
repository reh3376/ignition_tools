...
class DistillationWhiskeyAgent(BaseSpecializedAgent):
    ...
    def __init__(self: Self, agent_id: str = "distillation_whiskey_agent"):
        ...
        self.distillery_knowledge_path = os.getenv("WHISKEY_DISTILLATION_KNOWLEDGE_BASE_PATH", "data/whiskey_distillation")
        self.ttb_compliance_db = os.getenv("TTB_COMPLIANCE_DB_PATH", "data/ttb_compliance")
    ...
    def _get_process_considerations(self: Self, process_area: str) -> List[str]:
        ...
        return considerations.get(process_area, ["General distillation process considerations"])
