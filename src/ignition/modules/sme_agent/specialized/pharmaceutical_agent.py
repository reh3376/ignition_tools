...
class PharmaceuticalAgent(BaseSpecializedAgent):
    ...
    def _apply_gmp_principles(
        self: Self, task: AgentTask, process_area: str
    ) -> dict[str, Any]:
    ...
    def _get_process_recommendations(self: Self, process_area: str) -> list[str]:
        ...
        return recommendations.get(
            process_area, ["Follow pharmaceutical industry best practices"]
        )
