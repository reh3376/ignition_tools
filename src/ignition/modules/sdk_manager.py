...
class IgnitionSDKManager:
    ...
    def clone_module_tools(self) -> bool:
        ...
        try:
            with Progress(
                ...
                progress.add_task("Cloning module tools repository...", total=None)
    ...
    def build_module_tools(self) -> bool:
        ...
        if not generator_path.exists():
            console.print(
                "❌ collections.abc.collections.abc.collections.abc.collections.abc.collections.abc.collections.abc.collections.abc.Generator directory not found in module tools"  # noqa: E501
            )
            return False
        ...
        try:
            with Progress(
                ...
                progress.add_task("Building module tools...", total=None)
...
"""
    ...
    def get_environment_status(self) -> dict[str, Any]:
        ...
        # list projects
        status["projects"] = [self.get_project_info(p) for p in self.list_projects()]
