...
class CodeIntelligenceManager:
    ...
    def analyze_and_store_directory(self: Self, directory_path: Path, recursive: bool = True) -> dict[str, Any]:
    ...
    def find_similar_files(self: Self, file_path: str, limit: int = 10) -> list[dict[str, Any]]:
    ...
    def search_code(self: Self, query: str, search_type: str = "all") -> list[dict[str, Any]]:
    ...
    def get_dependency_graph(self: Self, file_path: str, depth: int = 2) -> dict[str, Any]:
