...
from src.ignition.graph.tasks.task_4_perspective_system import get_task_4_perspective_functions, get_task_4_metadata
import logging
...
def populate_task_4_functions():
    ...
    try:
        ...
        logger.info(f"Cleared existing Perspective functions and orphaned parameters")
