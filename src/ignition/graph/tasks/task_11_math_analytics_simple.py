    ...
    functions.extend([
        {
            ...
            "patterns": ["trigonometric_calculations", "engineering_math", "geometric_analysis", "scientific_computing"],
        },
        {
            ...
            "scope": ["Gateway", "Vision Client", "Perspective Session"],
            "category": "Mathematical Operations",
            "patterns": ["matrix_algebra", "linear_transformations", "engineering_calculations", "data_processing"],
        },
        {
            ...
            "scope": ["Gateway", "Vision Client", "Perspective Session"],
            "category": "Mathematical Operations",
            "patterns": ["unit_conversion", "engineering_units", "measurement_standardization", "industrial_calculations"],
        },
        {
