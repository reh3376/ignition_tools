...
try:
    ...
    from src.ignition.graph.tasks.task_5_device_communication import get_device_communication_functions
...
def populate_task_5_functions():
    ...
    categories = {
        "OPC Classic": [
            "system.opc.writeValues", "system.opc.readValues", "system.opc.browseSimple",
            "system.opc.getServerState", "system.opc.setServerEnabled", "system.opc.getServerInfo",
            "system.opc.subscribeToItems", "system.opc.unsubscribeFromItems"
        ],
        "OPC-UA": [
            "system.opcua.readValues", "system.opcua.writeValues", "system.opcua.browseNodes",
            "system.opcua.getConnectionInfo", "system.opcua.addConnection", "system.opcua.removeConnection",
            "system.opcua.callMethod", "system.opcua.createSubscription", "system.opcua.deleteSubscription",
            "system.opcua.getServerCertificate"
        ],
        "Device Management": [
            "system.device.addDevice", "system.device.removeDevice", "system.device.setDeviceEnabled",
            "system.device.getDeviceConfiguration", "system.device.setDeviceConfiguration",
            "system.device.getDeviceStatus", "system.device.restartDevice", "system.device.listDevices"
        ],
        "BACnet Protocol": [
            "system.bacnet.synchronizeTime", "system.bacnet.readProperty", "system.bacnet.writeProperty",
            "system.bacnet.releaseProperty", "system.bacnet.discoverDevices", "system.bacnet.readObjectList"
        ],
        "DNP3 Protocol": [
            "system.dnp3.request", "system.dnp3.sendDataSet", "system.dnp3.readClass0Data",
            "system.dnp3.readEventData", "system.dnp3.performIntegrityPoll"
        ]
    }
    ...
    try:
        ...
        if task_result:
            print(f"   ✅ Created Task 5 master node")
    ...
    # Final summary
    print(f"\n" + "="*60)
    print(f"📊 TASK 5 POPULATION SUMMARY")
    print(f"="*60)
...
if __name__ == "__main__":
    ...
    if success_count > 0:
        ...
        if success_count == total_count:
            print(f"   ✅ All Task 5 functions successfully populated!")
        else:
