        ...
        [
            {
                ...
                "returns": {"type": "str", "description": "Property value or default"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
        ...
        [
            {
                ...
                "returns": {"type": "str", "description": "Formatted date string"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Date/Time Operations",
                "patterns": ["date_formatting", "localization", "time_display"],
            },
            {
                ...
                "returns": {"type": "datetime", "description": "Parsed date object"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Date/Time Operations",
                "patterns": ["date_parsing", "input_validation", "time_processing"],
            },
            {
        ...
        [
            {
                ...
                "returns": {"type": "str", "description": "Base64 encoded string"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
            ...
            },
            {
                ...
                "returns": {"type": "bytes", "description": "Decoded binary data"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Data Encoding",
                "patterns": [
                    "data_decoding",
            ...
            },
            {
                ...
                "returns": {"type": "str", "description": "Generated UUID string"},
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
    ...
    functions.extend(
        [
            ...
            },
            {
                ...
                "returns": {"type": "bytes", "description": "Compressed data"},
                "scope": ["Gateway"],
            ...
            },
            {
                ...
                "returns": {"type": "bytes", "description": "Decompressed data"},
                "scope": ["Gateway"],
                "category": "Data Processing",
                "patterns": ["data_decompression", "data_recovery", "data_processing"],
            },
            {
            ...
            },
            {
                ...
                "patterns": ["audit_trail", "event_monitoring", "system_tracking"],
            },
            {
                ...
                "patterns": ["system_backup", "disaster_recovery", "data_protection"],
            },
            {
                ...
                "scope": ["Gateway"],
                "category": "Backup Management",
                "patterns": ["system_restore", "disaster_recovery", "data_recovery"],
            },
        ]
    )
