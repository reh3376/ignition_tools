...
class RecipeManager:
    ...
    def create_recipe(self, name: str, template: Dict[str, Any], description: str = "", version: str = "1.0") -> str:
        """
    ...
    def load_recipe(self, recipe_name: str, version: str = "latest") -> Optional[Dict[str, Any]]:
        """
    ...
    def execute_recipe(self, recipe_name: str, equipment_id: str, batch_id: str = "", execution_parameters: Dict[str, Any] = None) -> str:
        """
    ...
    def abort_execution(self, execution_id: str, abort_reason: str = "User requested", safe_abort: bool = True) -> bool:
        """
    ...
    def get_execution_status(self, execution_id: str, include_details: bool = False) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_execution_history(self, recipe_name: str, limit: int = 50, include_details: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def _estimate_total_execution_time(self, execution_data: Dict[str, Any]) -> Optional[datetime]:
