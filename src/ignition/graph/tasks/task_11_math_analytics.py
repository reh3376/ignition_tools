    ...
    functions.extend(
        [
            ...
            },
            {
                ...
                "returns": {
                    "type": "float",
                    "description": "Interpolated Y value with method metadata",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
            ...
            },
            {
                ...
                "parameters": [
                    {
                        "name": "dataPoints",
                        "type": "list",
                        "description": "Data points as [x, y] pairs",
                        "required": True,
                    },
                    {
                        "name": "order",
                        "type": "int",
                        "description": "Derivative order (1st, 2nd, etc.)",
                        "required": False,
                        "default": 1,
                    },
                    {
                        "name": "method",
                        "type": "str",
                        "description": "Calculation method (forward, backward, central)",
                        "required": False,
                        "default": "central",
                    },
                    {
                ...
                "returns": {
                    "type": "list",
                    "description": "Derivative values with calculation metadata",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
            ...
            },
            {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "method",
                        "type": "str",
                        "description": "Integration method (trapezoidal, simpson, rectangle)",
                        "required": False,
                        "default": "trapezoidal",
                    },
                    {
                ...
                "returns": {
                    "type": "float",
                    "description": "Integral value with calculation metadata",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
            ...
            },
            {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "integralSum",
                        "type": "float",
                        "description": "Accumulated integral term",
                        "required": False,
                        "default": 0.0,
                    },
                    {
                        "name": "previousError",
                        "type": "float",
                        "description": "Previous error value",
                        "required": False,
                        "default": 0.0,
                    },
                ],
                "returns": {
                    "type": "dict",
                    "description": "PID output with component values and updated state",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
            ...
            },
            {
                ...
                "parameters": [
                    {
                        "name": "functionData",
                        "type": "list",
                        "description": "Function data points",
                        "required": True,
                    },
                    {
                        "name": "optimizationType",
                        "type": "str",
                        "description": "Optimization type (minimize, maximize)",
                        "required": True,
                    },
                    {
                        "name": "method",
                        "type": "str",
                        "description": "Optimization method (gradient, simplex, genetic)",
                        "required": False,
                        "default": "gradient",
                    },
                    {
                ...
                "returns": {
                    "type": "dict",
                    "description": "Optimized parameters with convergence info",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
            ...
            },
            {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "name": "samplingRate",
                        "type": "float",
                        "description": "Data sampling rate (Hz)",
                        "required": True,
                    },
                    {
                        "name": "transformType",
                        "type": "str",
                        "description": "Transform type (FFT, DFT, inverse)",
                        "required": False,
                        "default": "FFT",
                    },
                    {
                        "name": "windowFunction",
                        "type": "str",
                        "description": "Window function (hamming, hanning, blackman)",
                        "required": False,
                        "default": "hamming",
                    },
                    {
                        "name": "zeroPadding",
                        "type": "bool",
                        "description": "Apply zero padding for better resolution",
                        "required": False,
                        "default": True,
                    },
                ],
                "returns": {
                    "type": "dict",
                    "description": "Frequency domain data with magnitude and phase",
                },
                "scope": ["Gateway", "Vision Client", "Perspective Session"],
                "category": "Mathematical Operations",
                "patterns": [
