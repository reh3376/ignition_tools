...
class PatternManager:
    ...
    def get_patterns_by_type(self, pattern_type: str, 
                           limit: int = 10,
                           min_confidence: float = 0.0,
                           min_support: float = 0.0) -> List[Dict[str, Any]]:
    ...
    def get_patterns_by_entity(self, entity_name: str, 
                             entity_type: str = "function") -> List[Dict[str, Any]]:
    ...
    def update_pattern_relevance(self, pattern_id: str, 
                               new_usage_count: Optional[int] = None,
                               success_feedback: Optional[bool] = None) -> bool:
    ...
    def cleanup_old_patterns(self, max_age_days: int = 180,
                           min_usage_threshold: int = 2) -> int:
        ...
        patterns_to_cleanup = self.client.execute_query(cleanup_query, {
    ...
    def get_top_patterns_summary(self, limit: int = 10) -> Dict[str, Any]:
        ...
        pattern_types = ["function_co_occurrence", "template_usage", 
                        "parameter_combination", "sequential_usage"]
    ...
    def export_patterns(self, pattern_type: Optional[str] = None,
    ...
    def maintain_patterns(self) -> Dict[str, Any]:
        ...
        logger.info(f"Pattern maintenance completed: {updated_count} updated, "
