...
class Neo4jBackupManager:
    ...
    def __init__(self, graph_client: Optional[IgnitionGraphClient] = None):
    ...
    def _restore_database_data(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for node_data in nodes:
                ...
                create_query = f"CREATE (n:{labels_str} $props) RETURN id(n) as new_id"
...
if __name__ == "__main__":
    ...
    parser.add_argument("action", choices=["backup", "restore", "list", "info", "auto", "init"],
    ...
    if args.action == "backup":
        ...
        if backups:
            ...
            for backup in backups:
                print(f"  • {backup['filename']} - {backup.get('datetime', 'Unknown')} - {backup.get('reason', 'No reason')}")
        else:
